...
def ingest_bhagavad_gita(csv_path: str, vector_store_path: str = "./vector_store/philosophical"):
    ...
    # Create documents
    documents = []
    # ⚡ Bolt Optimization: Use itertuples instead of iterrows for significantly faster row iteration
    # iterrows creates a Series object for each row, whereas itertuples returns a lightweight namedtuple
