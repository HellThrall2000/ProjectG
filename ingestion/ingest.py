...
def ingest_bhagavad_gita(csv_path: str, vector_store_path: str = "./vector_store/philosophical"):
    ...
    # Create documents
    documents = []
    # Optimization: Using itertuples() instead of iterrows() for significantly faster DataFrame iteration
    # bypasses Pandas Series creation overhead during document ingestion.
