...
def ingest_bhagavad_gita(csv_path: str, vector_store_path: str = "./vector_store/philosophical"):
    ...
    # Create documents
    documents = []
    # ⚡ Bolt: Using itertuples() instead of iterrows() for faster iteration over Pandas DataFrames.
    # iterrows() incurs significant overhead by converting rows to Series objects, while itertuples() returns fast namedtuples.
