...
def ingest_bhagavad_gita(csv_path: str, vector_store_path: str = "./vector_store/philosophical"):
    ...
    # Create documents
    documents = []
    # ⚡ Bolt: Optimized DataFrame iteration by replacing iterrows() with itertuples(index=False)
    # itertuples yields namedtuples and is significantly faster than iterrows which creates a Series per row.
